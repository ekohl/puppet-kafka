  ...
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      describe 'kafka::broker::service' do
        ...
        context 'defaults' do
          context 'with systemd', if: os_facts[:service_provider] == 'systemd' do
          ...
          context 'with non-systemd', unless: os_facts[:service_provider] == 'systemd' do
            it { is_expected.to contain_file('/etc/init.d/kafka').with_ensure('file') }
          end
